...
import { ssrRenderVNode, ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttrs, ssrRenderAttr, ssrRenderSuspense, ssrRenderStyle } from 'vue/server-renderer';
...
import { pipe, noop as noop$1, progress, clamp, secondsToMilliseconds, millisecondsToSeconds } from 'motion-utils';
...
const [injectConfigProviderContext, provideConfigProviderContext] = /* @__PURE__ */ createContext$1("ConfigProvider");
...
const [injectProgressRootContext, provideProgressRootContext] = /* @__PURE__ */ createContext$1("ProgressRoot");
...
const [injectToastProviderContext, provideToastProviderContext] = /* @__PURE__ */ createContext$1("ToastProvider");
...
const [injectToastRootContext, provideToastRootContext] = /* @__PURE__ */ createContext$1("ToastRoot");
...
const [injectTooltipProviderContext, provideTooltipProviderContext] = /* @__PURE__ */ createContext$1("TooltipProvider");
...
const [injectThemeContext] = createContext$1("UTheme", "RootContext");
            ...
            if (_push2) {
              ...
              return [
                __props.custom ? (openBlock(), createBlock(unref(Slot), { key: 0 }, {
                  ...
                  _: 2
                }, 1024)) : (openBlock(), createBlock(_sfc_main$d, mergeProps({ key: 1 }, {
                  ..._ctx.$attrs,
                  ...__props.exact && isExactActive ? { "aria-current": props.ariaCurrentValue } : {},
                  as: __props.as,
                  type: __props.type,
            ...
            return [
              !isIndeterminate.value && (__props.status || !!slots.status) ? (openBlock(), createBlock("div", {
                ...
                renderSlot(_ctx.$slots, "status", { percent: percent2.value }, () => [
                  createTextVNode(toDisplayString(percent2.value) + "% ", 1)
                ])
...
var InViewGesture = class extends Feature {
  ...
  startObserver() {
    ...
    this.removeObserver = inView(element, (_, entry2) => {
      const props = this.state.options;
      this.state.setActive("whileInView", true);
      if (props.onViewportEnter) frame.postRender(() => props.onViewportEnter(entry2));
      if (!once) return () => {
        this.state.setActive("whileInView", false);
        const leaveCallback = this.state.options.onViewportLeave;
        if (leaveCallback) frame.postRender(() => leaveCallback(entry2));
      };
    }, viewOptions);
  }
  mount() {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createVNode("div", { class: "navbar-logo-badge" }, "2026")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(unref(motion).line, {
        ...
        y2: "6",
        variants,
        animate: unref(mobileMenuOpen) ? "close" : "normal",
        custom: 1,
        class: "outline-none"
      }, null, _parent));
      _push(ssrRenderComponent(unref(motion).line, {
  ...
  setup(__props) {
    ...
    useHead({
      ...
      link: [
        ...
        { rel: "preload", href: "/fonts/Fractul-Thin.ttf", as: "font", type: "font/ttf", crossorigin: "" },
        { rel: "preload", href: "/fonts/Fractul-Regular.ttf", as: "font", type: "font/ttf", crossorigin: "" },
        { rel: "preload", href: "/fonts/Fractul-Black.ttf", as: "font", type: "font/ttf", crossorigin: "" },
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CGOOp2GY.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CBs362Q0.mjs'));
