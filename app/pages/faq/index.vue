  ...
  >
    ...
    <div class="max-w-[860px] mx-auto">
      <div class="text-center mb-[clamp(2.5rem,5vw,3.75rem)]">
        <span class="inline-block text-[1.5rem] font-black text-[#D946EF] uppercase tracking-[0.14em] mb-[0.75rem] [text-shadow:0_0_18px_rgba(217,70,239,0.3)]">Hackathon</span>
