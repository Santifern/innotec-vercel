...
useSeoMeta({
  title: 'Acerca del Congreso | INNOTEC 2026',
  ogTitle: 'Acerca del Congreso | INNOTEC 2026',
  description: 'Informacion del congreso INNOTEC 2026: fechas, sede, publico objetivo y ejes temáticos.',
  ogDescription: 'Informacion del congreso INNOTEC 2026: fechas, sede, publico objetivo y ejes temáticos.'
})
</script>

<template>
  <div class="innotec-page acerca-page">
    <section
      id="acerca"
      ...
      <div class="section-container acerca-container">
        ...
        >
          ...
          <p class="acerca-description">
            Cada edicion de INNOTEC propone acercar a los estudiantes a experiencias, herramientas e ideas que amplíen su formación más allá del ámbito académico, mostrando cómo la innovación, el diseño, la ingeniería y la arquitectura pueden articularse para transformar ideas en acciones con impacto en el mundo profesional y en la sociedad.
          </p>
        </Motion>
        ...
        <div class="acerca-ejes-grid">
          ...
          <Motion v-bind="staggerMotion(1)">
            ...
            >
              ...
              <h4 class="acerca-eje-title">
                De la Teoría al Territorio : proyectos, decisiones y aplicación en el campo
              </h4>
              <p class="acerca-eje-desc">
        ...
        <div class="acerca-info-grid">
          <Motion
            ...
            class="acerca-info-item acerca-info-item--dates"
          >
            <div
              class="acerca-info-card"
              @pointermove="updateCardHover"
              @pointerleave="resetCardHover"
            >
              <div class="acerca-card-header">
          ...
          <Motion
            ...
            class="acerca-info-item acerca-info-item--venue"
          >
            <div
              class="acerca-info-card"
              @pointermove="updateCardHover"
            ...
            >
              ...
              <p class="acerca-card-text">
                Salón Bicentenario del Paseo La Galería, Asunción, Paraguay.
              </p>
              <div class="acerca-map-card">
                <iframe
                  title="Mapa de Paseo La Galeria"
                  aria-label="Mapa interactivo de Paseo La Galeria"
                  src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3033.594586837846!2d-57.5632898079186!3d-25.284970358490114!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x945da95c9e1ac62d%3A0x80a919912d273b72!2sPaseo%20La%20Galeria%20Centro%20de%20Eventos!5e0!3m2!1ses!2sus!4v1779061008728!5m2!1ses!2sus"
                  loading="lazy"
              ...
              <a
                href="https://maps.app.goo.gl/6DwDZ3ufGv9iApxLA"
                target="_blank"
          ...
          <Motion
            ...
            class="acerca-info-item acerca-info-item--audience"
          >
            <div
              class="acerca-info-card"
              @pointermove="updateCardHover"
            ...
            >
              ...
              <p class="acerca-card-text">
                Estudiantes de ingeniería, arquitectura, diseño, informática, electrónica y análisis de sistemas de diferentes universidades del país.
                <br>
                Profesionales, académicos y expertos en las temáticas del congreso.
              </p>
            </div>
          </Motion>
        </div>

        <LazyInnotecOrganizadoresSection />
      </div>
    </section>
  </div>
</template>

<style scoped src="~/assets/css/pages/innotec-acerca.css"></style>
